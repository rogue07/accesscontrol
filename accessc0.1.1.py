...
def main():
    while True:
        ...
        # continuously update log file
#        try:
#            output = subprocess.run("tail -4 accessc.log",shell=True) 
#            print(output)
#        except:
#            subprocess.CalledProcessError
#            print("Error: Could not read file")
        subprocess.run("tail -4 accessc.log",shell=True)
        time.sleep(1)
